...
exports.Gateway = (function() {
  ...
  function Gateway(merchantId, merchantKey, test) {
    ...
    this.return = function(_return, callback) {
      var returnXML = mp_utils.buildReturnXML(_return, MP_API_VERSION, MP_AUTH, XML_OPTIONS);
      this.client.post(MP_POST_XML, returnXML, reqHandler(callback));
    };
    return this;
  }
